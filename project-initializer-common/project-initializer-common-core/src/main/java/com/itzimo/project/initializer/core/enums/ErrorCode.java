package com.itzimo.project.initializer.core.enums;
...
public enum ErrorCode implements IErrorCode {
    ...
    USER_REGISTRATION_AREA_LIMITED("A0102", "注册国家或地区受限"),
    ...
    SMS_VERIFICATION_CODE_ERROR("A0131", "短信校验码输入错误"),
    EMAIL_VERIFICATION_CODE_ERROR("A0132", "邮件校验码输入错误"),
    VOICE_VERIFICATION_CODE_ERROR("A0133", "语音校验码输入错误"),
    USER_CERTIFICATE_EXCEPTION("A0140", "用户证件异常"),
    USER_CERTIFICATE_TYPE_NOT_SELECTED("A0141", "用户证件类型未选择"),
    ID_CARD_VALIDATION_FAILED("A0142", "大陆身份证编号校验非法"),
    PASSPORT_VALIDATION_FAILED("A0143", "护照编号校验非法"),
    MILITARY_ID_VALIDATION_FAILED("A0144", "军官证编号校验非法"),
    USER_BASIC_INFO_VALIDATION_FAILED("A0150", "用户基本信息校验失败"),
    PHONE_FORMAT_VALIDATION_FAILED("A0151", "手机格式校验失败"),
    ADDRESS_FORMAT_VALIDATION_FAILED("A0152", "地址格式校验失败"),
    EMAIL_FORMAT_VALIDATION_FAILED("A0153", "邮箱格式校验失败"),

    // 用户登录异常 A0200 - A0299
    USER_LOGIN_EXCEPTION("A0200", "用户登录异常"),
    USER_ACCOUNT_NOT_EXISTS("A0201", "用户账户不存在"),
    USER_ACCOUNT_FROZEN("A0202", "用户账户被冻结"),
    USER_ACCOUNT_INVALID("A0203", "用户账户已作废"),
    USER_PASSWORD_ERROR("A0210", "用户密码错误"),
    USER_PASSWORD_RETRY_LIMIT_EXCEEDED("A0211", "用户输入密码错误次数超限"),
    USER_IDENTITY_VALIDATION_FAILED("A0220", "用户身份校验失败"),
    USER_FINGERPRINT_VALIDATION_FAILED("A0221", "用户指纹识别失败"),
    USER_FACE_VALIDATION_FAILED("A0222", "用户面容识别失败"),
    USER_THIRD_PARTY_AUTHORIZATION_FAILED("A0223", "用户未获得第三方登录授权"),
    USER_LOGIN_EXPIRED("A0230", "用户登录已过期"),
    USER_VERIFICATION_CODE_ERROR("A0240", "用户验证码错误"),
    USER_VERIFICATION_CODE_RETRY_LIMIT_EXCEEDED("A0241", "用户验证码尝试次数超限"),

    // 访问权限异常 A0300 - A0399
    ACCESS_PERMISSION_EXCEPTION("A0300", "访问权限异常"),
    ACCESS_UNAUTHORIZED("A0301", "访问未授权"),
    AUTHORIZATION_IN_PROGRESS("A0302", "正在授权中"),
    USER_AUTHORIZATION_REJECTED("A0303", "用户授权申请被拒绝"),
    ACCESS_BLOCKED_BY_PRIVACY_SETTINGS("A0310", "因访问对象隐私设置被拦截"),
    ...
    // 用户请求参数错误 A0400 - A0499
    USER_REQUEST_PARAMETER_ERROR("A0400", "用户请求参数错误"),
    ILLEGAL_REDIRECT_LINK("A0401", "包含非法恶意跳转链接"),
    ...
    CONTAINS_SENSITIVE_WORDS("A0431", "包含违禁词汇"),
    IMAGE_CONTAINS_SENSITIVE_INFO("A0432", "图片包含违禁信息"),
    FILE_COPYRIGHT_INFRINGEMENT("A0433", "文件侵犯版权"),
    ...
    USER_OPERATION_PENDING("A0503", "用户操作请等待"),
    ...
    // 用户当前版本异常 A0800 - A0899
    USER_CURRENT_VERSION_EXCEPTION("A0800", "用户当前版本异常"),
    USER_INSTALL_VERSION_MISMATCH("A0801", "用户安装版本与系统不匹配"),
    USER_INSTALL_VERSION_TOO_LOW("A0802", "用户安装版本过低"),
    USER_INSTALL_VERSION_TOO_HIGH("A0803", "用户安装版本过高"),
    USER_INSTALL_VERSION_EXPIRED("A0804", "用户安装版本已过期"),
    ...
    USER_CAMERA_NOT_AUTHORIZED_ALT("A0903", "用户相机未授权"),
    ...
    // ========== 第三方服务错误 C 开头 ==========
    EXTERNAL_SERVICE_ERROR("C0001", "调用第三方服务出错"),
    ...
    CACHE_KEY_TOO_LONG("C0131", "key 长度超过限制"),
    CACHE_VALUE_TOO_LONG("C0132", "value 长度超过限制"),
    CACHE_STORAGE_FULL("C0133", "存储容量已满"),
    CACHE_UNSUPPORTED_DATA_FORMAT("C0134", "不支持的数据格式"),

    // 配置服务出错 C0140 - C0149
    CONFIG_SERVICE_ERROR("C0140", "配置服务出错"),

    // 网络资源服务出错 C0150 - C0159
    ...
    // 第三方系统执行超时 C0200 - C0299
    EXTERNAL_SYSTEM_EXECUTION_TIMEOUT("C0200", "第三方系统执行超时"),
    ...
    DUPLICATE_COLUMN_NAMES("C0321", "多表关联中存在多个相同名称的列"),
    DATABASE_DEADLOCK("C0331", "数据库死锁"),
    PRIMARY_KEY_CONFLICT("C0341", "主键冲突"),

    // 第三方容灾系统被触发 C0400 - C0499
    EXTERNAL_DISASTER_RECOVERY_TRIGGERED("C0400", "第三方容灾系统被触发"),
    EXTERNAL_SYSTEM_CURRENT_LIMITING("C0401", "第三方系统限流"),
    EXTERNAL_FUNCTION_DEGRADATION("C0402", "第三方功能降级"),
